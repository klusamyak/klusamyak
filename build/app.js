...
.config(['$stateProvider',
    ...
    $stateProvider
        ...
        .state('kluinfo', {
            url: "/kluinfo",
            templateUrl: "templates/kluinfo.html" 
          })
        .state('wikitude', {
            url: "/wikitude",
            templateUrl: "templates/wikitude.html" 
          })
         .state('item', {
            url: "/item",
       ...
       .state('cse', {
           ...
           .state('bba', {
            url: "/bba",
            templateUrl: "templates/bba.html" 
          })
       ...
       .state('bhm', {
            url: "/bhm",
            templateUrl: "templates/bhm.html" 
          })
        .state('ece', { 
            url: "/ece",
